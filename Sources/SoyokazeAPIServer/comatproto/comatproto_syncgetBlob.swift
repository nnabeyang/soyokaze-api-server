...
extension comatprototypes {
    public enum SyncGetBlob {
      ...
      public struct Input: Sendable, Hashable {
          public struct Query: Sendable, Hashable {
              ...
              public init(cid: String, did: String) {
                self.cid = cid
                self.did = did
            }
        }
    ...
    @available(*, deprecated, message: "Use `SyncGetBlob.Error` instead.")
    public typealias SyncGetBlob_Error = SyncGetBlob.Error
}
