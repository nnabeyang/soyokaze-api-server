...
extension comatprototypes {
    public enum RepoCreateRecord {
      public static let id = "com.atproto.repo.createRecord"
      public struct Input: Sendable, Hashable {
        public struct Headers: Sendable, Hashable {
          public var accept: [OpenAPIRuntime.AcceptHeaderContentType<RepoCreateRecord.AcceptableContentType>]
          public init(accept: [OpenAPIRuntime.AcceptHeaderContentType<RepoCreateRecord.AcceptableContentType>] = .defaultValues()) {
            self.accept = accept
          }
        }
        public var headers: RepoCreateRecord.Input.Headers

        @frozen public enum Body: Sendable, Hashable {
          case json(RepoCreateRecord_Input)
        }
        public var body: RepoCreateRecord.Input.Body

        public init(
          headers: RepoCreateRecord.Input.Headers,
          body: RepoCreateRecord.Input.Body
        ) {
      ...
      @frozen public enum Output: Sendable, Hashable {
        public struct Ok: Sendable, Hashable {
          ...
          public var body: RepoCreateRecord.Output.Ok.Body

          public init(body: RepoCreateRecord.Output.Ok.Body) {
            self.body = body
          }
        }

        case ok(RepoCreateRecord.Output.Ok)

        public var ok: RepoCreateRecord.Output.Ok {
          get throws {
            switch self {
    ...
    @available(*, deprecated, message: "Use `RepoCreateRecord.Error` instead.")
    public typealias RepoCreateRecord_Error = RepoCreateRecord.Error
}
